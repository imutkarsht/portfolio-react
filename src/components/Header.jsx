...
const Header = () => {
  ...
  return (
    <>
      <div className="flex items-center justify-between px-2 dark:bg-primary-2  dark:text-white text-black bg-primary-1 py-3">
      ...
      <div className='w-full h-0.5 dark:bg-white bg-black'></div>
