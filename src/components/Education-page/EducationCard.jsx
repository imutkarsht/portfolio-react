    ...
    return (
        <div className="content-ed grid xl:mx-32 md:mx-16 sm:mx-0 sm:ml-10 xl:grid-cols-2 xl:gap-16 ml-3 mr-3 gap-3  grid-cols-1 align-middle">
            {educationItems.map((item, index) => (
                <div key={index} className="box flex flex-col relative p-5 border  rounded-md bg-content-1 dark:bg-content-2 dark:text-white cursor-pointer transition-all duration-400 mb-5 bg-opacity-30 dark:border-white border-black dark:bg-opacity-60 hover:shadow-md hover:dark:shadow-content-main-text-2 hover:shadow-content-main-text-1"
                >
