            ...
            {ProbSolv.map((item) => {
                ...
                return (
                    <Link to={item.link} target='_blank' key={item.id}>
                        <div className={`flex flex-col md:m-4 m-1 border-2 bg-opacity-50 dark:bg-opacity-50 border-content-main-text-1 dark:border-content-main-text-2 rounded-lg transition-all ease-in-out duration-150 cursor-pointer items-center justify-center dark:bg-content-2 bg-content-1 hover:shadow-md hover:dark:shadow-content-main-text-2 hover:shadow-content-main-text-1 ${shadowClass}`}>
