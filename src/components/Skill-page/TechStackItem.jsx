    ...
    return (
        <div className='flex flex-wrap justify-center md:gap-0 gap-1'>
            {TechStack.map((item) => {
                ...
                return (
                    <div key={item.id} className='flex flex-col md:m-4 m-1 border-2 rounded-lg hover:shadow-md transition-all ease-in-out duration-150 cursor-pointer dark:bg-gray-950 hover:dark:shadow-slate-200'
                    >
